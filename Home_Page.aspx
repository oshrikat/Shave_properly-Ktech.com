<%@ Page Language="C#"  AutoEventWireup="true" CodeBehind="Home_Page.aspx.cs" Inherits="Giluah_Kehalaha___NEW_WEBSITE_2022.Home_Page" %>
    ...
    <div id="middle2">
     ...
     <%--   <section id="my_survey">
        <div id="survey">
            ...
            <input type="radio" name="options" value="הכשרצומת" checked="checked" />
             <label>  
                הכשר צומת
            </label>
            <br />
            ...
            <input type="radio" name="options" value="הכשרמחמיר" />
