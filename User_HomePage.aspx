<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="User_HomePage.aspx.cs" Inherits="Giluah_Kehalaha___NEW_WEBSITE_2022.User_HomePage" %>
...
<head runat="server">
     ...
     <title> דף הבית למשתמש מחובר</title>
...
<body>
    ...
    <br />
        ...
        <section id="my_survey">
        <div id="survey">
        
            <h4>   איזה הכשר הייתם מעדיפים במכונת גילוח? </h4>
              <br />
       
            <form action="" method="post" >
            <input type="radio" name="options" value="justCosher" checked="checked" />
             <label>  
                הכשר צומת
            </label>
                &nbsp;  &nbsp;    <%=JustCosher %>
            ...
            <input type="radio" name="options" value="rigorousChoser" />
            ...
            <br />
            <br /> 
                <input type="radio" name="options" value="dontmind" />
            ...
            <br />
            <br />
            <input type="submit" name="submit" value="שליחה" id="SurveyButton" />
                </form>
